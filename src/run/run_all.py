...
from src.run.static_recursive_run import run_static_recursive
from src.run.recursion_wise_state_run import run_recursion_wise_state
from src.run.dynamic_mor_run import run_dynamic_mor
from src.run.grouped_parameter_reduction_run import run_grouped_parameter_reduction
...
if __name__ == "__main__":
    ...
    run_mor()
    run_mamba()
    run_static_recursive()
    run_recursion_wise_state()
    run_dynamic_mor()

    run_grouped_parameter_reduction()
